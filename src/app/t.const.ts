const T = {
  APP: {
    ...
    B_RECOVERY_POINT: {
      BROWSE: 'APP.B_RECOVERY_POINT.BROWSE',
      DISMISS: 'APP.B_RECOVERY_POINT.DISMISS',
      MSG: 'APP.B_RECOVERY_POINT.MSG',
    },
    B_SYNC_SAFETY: {
  ...
  CONFIRM: {
    ...
    RESTORE_FILE_BACKUP_WITH_COUNTS: 'CONFIRM.RESTORE_FILE_BACKUP_WITH_COUNTS',
  ...
  F: {
    ANDROID: {
      TIME_RECOVERY_FAILED: 'F.ANDROID.TIME_RECOVERY_FAILED',
      ...
      CAPTURES_IMPORTED: 'F.ANDROID.CAPTURES_IMPORTED',
      CAPTURE_IMPORT_ERROR: 'F.ANDROID.CAPTURE_IMPORT_ERROR',
    },
    ATTACHMENT: {
    ...
    ISSUE: {
      ...
      S: {
        ...
        CONNECTION_FAILED_WITH_ERROR: 'F.ISSUE.S.CONNECTION_FAILED_WITH_ERROR',
    ...
    JIRA: {
      ...
      FORM_ADV: {
        ...
        IS_SYNC_DEADLINE_TO_JIRA: 'F.JIRA.FORM_ADV.IS_SYNC_DEADLINE_TO_JIRA',
    ...
    PROJECT: {
      ...
      S: {
        ...
        DISCARDED: 'F.PROJECT.S.DISCARDED',
    ...
    SYNC: {
      ...
      D_NOTHING_TO_UPLOAD: {
        MESSAGE: 'F.SYNC.D_NOTHING_TO_UPLOAD.MESSAGE',
        MESSAGE_CHANGE_PW: 'F.SYNC.D_NOTHING_TO_UPLOAD.MESSAGE_CHANGE_PW',
        TITLE: 'F.SYNC.D_NOTHING_TO_UPLOAD.TITLE',
      },
      D_PERMISSION: {
      ...
      S: {
        ...
        BTN_RESOLVE_CONFLICT: 'F.SYNC.S.BTN_RESOLVE_CONFLICT',
    ...
    TASK: {
      ...
      ADDITIONAL_INFO: {
        ...
        OPEN_IN_FULLSCREEN: 'F.TASK.ADDITIONAL_INFO.OPEN_IN_FULLSCREEN',
      },
      B: {
      ...
      CMP: {
        ...
        PRIORITY: 'F.TASK.CMP.PRIORITY',
        PRIORITY_HIGH: 'F.TASK.CMP.PRIORITY_HIGH',
        PRIORITY_LOW: 'F.TASK.CMP.PRIORITY_LOW',
        PRIORITY_MEDIUM: 'F.TASK.CMP.PRIORITY_MEDIUM',
        PRIORITY_NONE: 'F.TASK.CMP.PRIORITY_NONE',
      ...
      MULTI_SELECT: {
        ACTIONS: 'F.TASK.MULTI_SELECT.ACTIONS',
        CLEAR: 'F.TASK.MULTI_SELECT.CLEAR',
        D_CONFIRM_DELETE: {
          MSG: {
            ONE: 'F.TASK.MULTI_SELECT.D_CONFIRM_DELETE.MSG.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.D_CONFIRM_DELETE.MSG.OTHER',
          },
          OK: 'F.TASK.MULTI_SELECT.D_CONFIRM_DELETE.OK',
        },
        S: {
          DEADLINE_REMOVED: {
            ONE: 'F.TASK.MULTI_SELECT.S.DEADLINE_REMOVED.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.DEADLINE_REMOVED.OTHER',
          },
          DEADLINE_SET: {
            ONE: 'F.TASK.MULTI_SELECT.S.DEADLINE_SET.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.DEADLINE_SET.OTHER',
          },
          DONE: {
            ONE: 'F.TASK.MULTI_SELECT.S.DONE.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.DONE.OTHER',
          },
          ESTIMATE_CLEARED: {
            ONE: 'F.TASK.MULTI_SELECT.S.ESTIMATE_CLEARED.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.ESTIMATE_CLEARED.OTHER',
          },
          ESTIMATE_SET: {
            ONE: 'F.TASK.MULTI_SELECT.S.ESTIMATE_SET.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.ESTIMATE_SET.OTHER',
          },
          MOVED_TO_BACKLOG: {
            ONE: 'F.TASK.MULTI_SELECT.S.MOVED_TO_BACKLOG.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.MOVED_TO_BACKLOG.OTHER',
            PARTIAL: 'F.TASK.MULTI_SELECT.S.MOVED_TO_BACKLOG.PARTIAL',
          },
          MOVED_TO_PROJECT: {
            ONE: 'F.TASK.MULTI_SELECT.S.MOVED_TO_PROJECT.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.MOVED_TO_PROJECT.OTHER',
            PARTIAL: 'F.TASK.MULTI_SELECT.S.MOVED_TO_PROJECT.PARTIAL',
          },
          MOVED_TO_REGULAR: {
            ONE: 'F.TASK.MULTI_SELECT.S.MOVED_TO_REGULAR.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.MOVED_TO_REGULAR.OTHER',
            PARTIAL: 'F.TASK.MULTI_SELECT.S.MOVED_TO_REGULAR.PARTIAL',
          },
          NOTHING_TO_DO: 'F.TASK.MULTI_SELECT.S.NOTHING_TO_DO',
          PRIORITY_CLEARED: {
            ONE: 'F.TASK.MULTI_SELECT.S.PRIORITY_CLEARED.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.PRIORITY_CLEARED.OTHER',
          },
          PRIORITY_SET: {
            ONE: 'F.TASK.MULTI_SELECT.S.PRIORITY_SET.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.PRIORITY_SET.OTHER',
          },
          SCHEDULED: {
            ONE: 'F.TASK.MULTI_SELECT.S.SCHEDULED.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.SCHEDULED.OTHER',
          },
          UNDONE: {
            ONE: 'F.TASK.MULTI_SELECT.S.UNDONE.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.UNDONE.OTHER',
          },
          UNSCHEDULED: {
            ONE: 'F.TASK.MULTI_SELECT.S.UNSCHEDULED.ONE',
            OTHER: 'F.TASK.MULTI_SELECT.S.UNSCHEDULED.OTHER',
          },
        },
        SELECTED_COUNT: 'F.TASK.MULTI_SELECT.SELECTED_COUNT',
        SELECT_ENTRY: 'F.TASK.MULTI_SELECT.SELECT_ENTRY',
        TASKS_TITLE: {
          ONE: 'F.TASK.MULTI_SELECT.TASKS_TITLE.ONE',
          OTHER: 'F.TASK.MULTI_SELECT.TASKS_TITLE.OTHER',
        },
      },
      N: {
    ...
    TASK_VIEW: {
      CUSTOMIZER: {
        ...
        FILTER_PRIORITY: 'F.TASK_VIEW.CUSTOMIZER.FILTER_PRIORITY',
        ...
        SORT_PRIORITY: 'F.TASK_VIEW.CUSTOMIZER.SORT_PRIORITY',
  ...
  G: {
    ...
    NEXT: 'G.NEXT',
    NEXT_MONTH: 'G.NEXT_MONTH',
    NEXT_WEEK: 'G.NEXT_WEEK',
    NO_CON: 'G.NO_CON',
    NONE: 'G.NONE',
    OK: 'G.OK',
  ...
  GCF: {
    ...
    AUTO_BACKUPS: {
      BROWSE: 'GCF.AUTO_BACKUPS.BROWSE',
      D_LIST: {
        BTN_RESTORE: 'GCF.AUTO_BACKUPS.D_LIST.BTN_RESTORE',
        CONFIRM_MSG: 'GCF.AUTO_BACKUPS.D_LIST.CONFIRM_MSG',
        CONFIRM_TITLE: 'GCF.AUTO_BACKUPS.D_LIST.CONFIRM_TITLE',
        DATE_UNKNOWN: 'GCF.AUTO_BACKUPS.D_LIST.DATE_UNKNOWN',
        EMPTY: 'GCF.AUTO_BACKUPS.D_LIST.EMPTY',
        ERROR_LOADING: 'GCF.AUTO_BACKUPS.D_LIST.ERROR_LOADING',
        ERROR_RESTORE: 'GCF.AUTO_BACKUPS.D_LIST.ERROR_RESTORE',
        INTRO: 'GCF.AUTO_BACKUPS.D_LIST.INTRO',
        KIND_FILE: 'GCF.AUTO_BACKUPS.D_LIST.KIND_FILE',
        LOADING: 'GCF.AUTO_BACKUPS.D_LIST.LOADING',
        PARTIAL: 'GCF.AUTO_BACKUPS.D_LIST.PARTIAL',
        REASON_FORCE_DOWNLOAD: 'GCF.AUTO_BACKUPS.D_LIST.REASON_FORCE_DOWNLOAD',
        REASON_LOCAL_IMPORT: 'GCF.AUTO_BACKUPS.D_LIST.REASON_LOCAL_IMPORT',
        REASON_REMOTE_IMPORT: 'GCF.AUTO_BACKUPS.D_LIST.REASON_REMOTE_IMPORT',
        SLOT_LATEST: 'GCF.AUTO_BACKUPS.D_LIST.SLOT_LATEST',
        SLOT_PREVIOUS: 'GCF.AUTO_BACKUPS.D_LIST.SLOT_PREVIOUS',
        TASK_COUNT: 'GCF.AUTO_BACKUPS.D_LIST.TASK_COUNT',
        TITLE: 'GCF.AUTO_BACKUPS.D_LIST.TITLE',
      },
    ...
    KEYBOARD: {
      ...
      TASK_TOGGLE_SELECT: 'GCF.KEYBOARD.TASK_TOGGLE_SELECT',
    ...
    MISC: {
      APPEARANCE: 'GCF.MISC.APPEARANCE',
    ...
    SCHEDULE: {
      ...
      WORK_END_DESCRIPTION: 'GCF.SCHEDULE.WORK_END_DESCRIPTION',
      WORK_START_DESCRIPTION: 'GCF.SCHEDULE.WORK_START_DESCRIPTION',
    },
    SHORT_SYNTAX: {
  ...
  GLOBAL_SNACK: {
    ACTION_REJECTED: 'GLOBAL_SNACK.ACTION_REJECTED',
  ...
  PLAINSPACE: {
    ...
    CONNECT: {
      ...
      UNREACHABLE: 'PLAINSPACE.CONNECT.UNREACHABLE',
    },
    FORM: {
    ...
    SPACE_PICKER: {
      ...
      DISCONNECT: 'PLAINSPACE.SPACE_PICKER.DISCONNECT',
      DISCONNECT_HINT: 'PLAINSPACE.SPACE_PICKER.DISCONNECT_HINT',
  ...
  PLUGINS: {
    ...
    PLUGIN_INSTALLED: 'PLUGINS.PLUGIN_INSTALLED',
